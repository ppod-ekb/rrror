...
export interface OptimizationSplitChunksOptions {
	...
	/**
	 * Assign modules to a cache group (modules from different cache userGroups are tried to keep in separate chunks)
	 */
	cacheGroups?: {
		/**
...
export interface StatsOptions {
	...
	children?: boolean;
	/**
	 * Display all chunk userGroups with the corresponding bundles
	 */
	chunkGroups?: boolean;
	/**
